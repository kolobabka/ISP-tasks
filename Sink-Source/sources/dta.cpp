...
QBDI::VMAction readDetector (QBDI::VM *vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data)
{
...
QBDI::VMAction writeDetector (QBDI::VM *vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data)
{
...
QBDI::VMAction retSourceDetector (QBDI::VM *vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data)
{
    Memory::Info *inf = static_cast<Memory::Info *> (data);
...
QBDI::VMAction enterSinkDetector (QBDI::VM *vm, QBDI::GPRState *gprState, QBDI::FPRState *fprState, void *data)
{
    Memory::Info *info = static_cast<Memory::Info *> (data);
